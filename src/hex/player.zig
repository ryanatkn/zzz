...
/// Legacy player update function (kept for compatibility)
pub fn updatePlayer(player: *entities.Player, input_state: *const InputState, zone: *const entities.Zone, cam: *const camera.Camera, deltaTime: f32) void {
...
/// Legacy movement direction getter (kept for compatibility)
pub fn getPlayerMovementDirection(player: *const entities.Player) Vec2 {
