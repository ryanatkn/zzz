...
const FontsInfoPage = struct {
    ...
    fn render(self: *const page.Page, links: *std.ArrayList(page.Link)) !void {
        ...
        // DM Mono info
        try links.append(page.createLink(
            "• DM Mono - Monospace font for code",
            "",
            center_x - link_width / 2.0 + 20,
            y_pos,
            link_width - 20,
            link_height
        ));
        ...
        // DM Sans info
        try links.append(page.createLink(
            "• DM Sans - Sans-serif for UI elements",
            "",
            center_x - link_width / 2.0 + 20,
            y_pos,
            link_width - 20,
        ...
        try links.append(page.createLink(
            "  Optical sizes: 18pt, 24pt, 36pt variants",
            "",
            center_x - link_width / 2.0 + 40,
            y_pos,
            link_width - 40,
        ...
        try links.append(page.createLink(
            "• DM Serif Display - Serif for headings",
            "",
            center_x - link_width / 2.0 + 20,
            y_pos,
            link_width - 20,
