<script lang="ts">
	...
	// TODO BLOCK here and elsewhere, detect when session is loaded via state and show loaders until then, but error messages if the request fails (no backend capability)
