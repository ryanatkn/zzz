...
import type {Frontend_Action_Event} from '$lib/frontend_action_event.js';
...
/**
 * `Frontend_Action_Handler`s are synchronous functions that apply state changes to the client app
