...
pub const TextLayout = struct {
    ...
    pub fn getCapabilities(self: *TextLayout) interface.AlgorithmCapabilities {
        _ = self;
    ...
    pub fn canHandle(self: *TextLayout, elements: []const LayoutElement, context: LayoutContext) bool {
        _ = self;
        _ = context;
    ...
    /// Get algorithm name
    pub fn getName(self: *TextLayout) []const u8 {
        _ = self;
        return "Text Layout";
    }
};
