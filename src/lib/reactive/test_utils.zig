...
pub fn TestContext(comptime T: type) type {
    return struct {
        ...
        pub fn createFunction(self: *Self, comptime func: fn (*T) void) *const fn () void {
        ...
        pub fn createParameterizedFunction(self: *Self, comptime RetType: type, comptime func: fn (*T) RetType) *const fn () RetType {
            const Wrapper = struct {
                context: *T,
