...
pub const DebugOverlayData = struct {
    ...
    pub fn addValue(
        ...
        initial_value: DebugValue.ValueType,
...
pub const DebugOverlay = struct {
    ...
    pub fn init(
        ...
        const overlay_data = try DebugOverlayData.init(
            allocator, position, font_size, line_height, color, background_color, max_values, update_interval_ms
        );
