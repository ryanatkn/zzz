...
test {
    ...
    _ = @import("../layout/algorithms/text/baseline.zig");
    _ = @import("../layout/algorithms/position/mod.zig");
}
...
test "UI integration: text input with proper baseline and cursor alignment" {
    ...
    const text_baseline = @import("../layout/algorithms/text/baseline.zig");
...
// TODO: Re-enable when UI flexbox integration is ready
// test "UI integration: flexbox layout with box model spacing" {
//     const testing = std.testing;
//     const box_model = @import("../layout/algorithms/box_model/cpu.zig");
//     const flexbox_mod = @import("../layout/algorithms/flex/mod.zig");
//     const reactive = @import("../reactive/mod.zig");
//     const math = @import("../math/mod.zig");
...
// TODO: Re-enable when box model is stabilized in algorithms/box_model/
