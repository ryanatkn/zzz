...
pub fn createDefault(allocator: std.mem.Allocator) !FPSCounter {
    return FPSCounter.init(
        allocator,
        FPSCounterPresets.default_white.position,
        FPSCounterPresets.default_white.font_size,
        FPSCounterPresets.default_white.color,
        FPSCounterPresets.default_white.update_interval_ms
    );
}
...
pub fn createDebugOverlay(allocator: std.mem.Allocator) !FPSCounter {
    return FPSCounter.init(
        allocator,
        FPSCounterPresets.debug_overlay.position,
        FPSCounterPresets.debug_overlay.font_size,
        FPSCounterPresets.debug_overlay.color,
        FPSCounterPresets.debug_overlay.update_interval_ms
    );
}
...
pub fn createSmallCorner(allocator: std.mem.Allocator) !FPSCounter {
    return FPSCounter.init(
        allocator,
        FPSCounterPresets.small_corner.position,
        FPSCounterPresets.small_corner.font_size,
        FPSCounterPresets.small_corner.color,
        FPSCounterPresets.small_corner.update_interval_ms
    );
}
