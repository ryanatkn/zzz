...
pub const RectangleRenderer = struct {
    ...
    pub fn init(
        ...
        const instance_buffer = buffers.InstanceBuffers.createRectInstanceBuffer(device) catch |err| {
            return err;
        };
    ...
    pub fn drawRect(
        ...
        rendering_core.UniformPush.pushRectUniforms(cmd_buffer, uniform_data);
