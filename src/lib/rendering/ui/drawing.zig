...
const simple_gpu_renderer = @import("../core/gpu.zig");
...
pub fn drawBorderedRect(gpu: *GPURenderer, cmd_buffer: *c.sdl.SDL_GPUCommandBuffer, render_pass: *c.sdl.SDL_GPURenderPass, pos: Vec2, size: Vec2, fill_color: Color, border_color: Color, border_width: f32) void {
    // Draw fill
...
pub fn drawPanel(gpu: *GPURenderer, cmd_buffer: *c.sdl.SDL_GPUCommandBuffer, render_pass: *c.sdl.SDL_GPURenderPass, pos: Vec2, size: Vec2, style: PanelStyle) void {
...
pub fn drawButton(gpu: *GPURenderer, cmd_buffer: *c.sdl.SDL_GPUCommandBuffer, render_pass: *c.sdl.SDL_GPURenderPass, pos: Vec2, size: Vec2, state: ButtonState) void {
...
pub fn drawNavigationBar(gpu: *GPURenderer, cmd_buffer: *c.sdl.SDL_GPUCommandBuffer, render_pass: *c.sdl.SDL_GPURenderPass, screen_width: f32, bar_width: f32, bar_height: f32, bar_y: f32) void {
...
pub fn drawOverlay(gpu: *GPURenderer, cmd_buffer: *c.sdl.SDL_GPUCommandBuffer, render_pass: *c.sdl.SDL_GPURenderPass, screen_width: f32, screen_height: f32, overlay_color: ?Color) void {
...
pub fn drawCenteredRect(gpu: *GPURenderer, cmd_buffer: *c.sdl.SDL_GPUCommandBuffer, render_pass: *c.sdl.SDL_GPURenderPass, screen_width: f32, screen_height: f32, rect_width: f32, rect_height: f32, color: Color) void {
