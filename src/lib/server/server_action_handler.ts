 ...
 */
export type Public_Server_Action_Handler<T_Input = any, T_Output = any> = (
	event: Server_Action_Event<T_Input, T_Output>,
) => Promise<T_Output>;

/**
 * Server action handler with full authorization with a user/actor (including authentication).
 */
export type Authorized_Server_Action_Handler<T_Input = any, T_Output = any> = (
	event: Server_Action_Event<T_Input, T_Output>,
) => Promise<T_Output>;
 ...
 */
export type Server_Action_Handler<T_Input = any, T_Output = any> =
	| Public_Server_Action_Handler<T_Input, T_Output>
	| Authorized_Server_Action_Handler<T_Input, T_Output>;
