...
/**
 * Request/Response action event for frontend.
 */
export class Frontend_Request_Response_Action_Event<
...
/**
 * Remote notification action event for frontend.
 */
export class Frontend_Remote_Notification_Action_Event<
	T_Method extends Action_Method = Action_Method,
	T_Input extends Action_Input = Action_Input,
> extends Action_Event<
	T_Input,
...
/**
 * Local call action event for frontend.
 */
export class Frontend_Local_Call_Action_Event<
	T_Method extends Action_Method = Action_Method,
	T_Input extends Action_Input = Action_Input,
	T_Output extends Action_Output = Action_Output,
> extends Action_Event<
...
export const create_frontend_action_event = (
	app: Zzz_App,
	spec: Action_Spec,
	input: unknown,
	...
	switch (spec.kind) {
		case 'request_response':
			return new Frontend_Request_Response_Action_Event(spec, app, input);
		case 'remote_notification':
			return new Frontend_Remote_Notification_Action_Event(spec, app, input);
		case 'local_call':
			return new Frontend_Local_Call_Action_Event(spec, app, input);
	}
};
...
export const frontend_action_event_from_json = (
	...
	const event = create_frontend_action_event(app, spec, json.input);
