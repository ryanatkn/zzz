	...
	modules: {
		...
		'./schemas.js': {
			...
			declarations: [
				...
				{name: 'Action_Ping_Spec', kind: 'variable'},
				{name: 'Action_Pong_Spec', kind: 'variable'},
				{name: 'Action_Load_Session_Spec', kind: 'variable'},
				{name: 'Action_Loaded_Session_Spec', kind: 'variable'},
				{name: 'Action_Filer_Change_Spec', kind: 'variable'},
				{name: 'Action_Update_Diskfile_Spec', kind: 'variable'},
				{name: 'Action_Delete_Diskfile_Spec', kind: 'variable'},
				{name: 'Action_Create_Directory_Spec', kind: 'variable'},
				{name: 'Action_Send_Prompt_Spec', kind: 'variable'},
				{name: 'Action_Completion_Response_Spec', kind: 'variable'},
