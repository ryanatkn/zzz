	...
	modules: {
		...
		'./action_collections.js': {
			...
			declarations: [
				...
				{name: 'Action_Input_For', kind: 'type'},
				{name: 'Action_Output_For', kind: 'type'},
		...
		'./action_types.js': {
			...
			declarations: [
				...
				{name: 'Action_Request_Response_Data', kind: 'variable'},
				{name: 'Action_Remote_Notification_Data', kind: 'variable'},
				{name: 'Action_Local_Call_Data', kind: 'variable'},
				{name: 'Action_Data', kind: 'variable'},
