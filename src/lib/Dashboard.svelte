...
<div style:--sidebar_width="{sidebar_width}px">
		...
		<div class="h_100 w_100 pt_sm pl_sm" style:width="var(--sidebar_width)">
			...
			<nav class="panel column size_lg p_sm overflow_auto" style:max-height="100%">
				...
				<Nav_Link href="{base}/providers"
					><span class="icon_inline_xs">{SYMBOL_PROVIDER}</span> providers</Nav_Link
				>
				<Nav_Link href="{base}/models"
					><span class="icon_inline_xs">{SYMBOL_MODEL}</span> models</Nav_Link
				>
				...
				<Nav_Link href="{base}/about"
					><span class="icon_inline_xs">{SYMBOL_ABOUT}</span> about</Nav_Link
				>
				<Nav_Link href="{base}/capabilities"
					><span class="icon_inline_xs">{SYMBOL_CAPABILITIES}</span> capabilities</Nav_Link
				>
				<!-- TODO more - terminal, database, account -->
				<Nav_Link href="{base}/settings"
					><span class="icon_inline_xs">{SYMBOL_SETTINGS}</span> settings</Nav_Link
				>
				...
				<!-- Quick Actions -->
				<!-- <h3 class="mb_xs">Quick Actions</h3>
				...
				<!-- Communication -->
				<!-- <h3 class="mb_xs">Communication</h3>
 ...
 -->
				...
				<!-- Collaboration -->
				<!-- <h3 class="mb_xs">Collaboration</h3>
