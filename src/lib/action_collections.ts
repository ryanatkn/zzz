...
const collect_action_specs_by_method = (
	obj: Record<string, Action_Spec>,
): Record<string, Action_Spec> => {
 ...
 */
export const action_spec_by_method: Record<Action_Method, Action_Spec> =
	collect_action_specs_by_method(action_spec_module);
