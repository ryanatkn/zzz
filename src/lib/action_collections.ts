...
export interface Action_Event_Datas {
	completion_create: Action_Event_Request_Response_Data<'completion_create'>;
	completion_progress: Action_Event_Remote_Notification_Data<'completion_progress'>;
	directory_create: Action_Event_Request_Response_Data<'directory_create'>;
	diskfile_delete: Action_Event_Request_Response_Data<'diskfile_delete'>;
	diskfile_update: Action_Event_Request_Response_Data<'diskfile_update'>;
	...
	provider_load_status: Action_Event_Request_Response_Data<'provider_load_status'>;
	provider_update_api_key: Action_Event_Request_Response_Data<'provider_update_api_key'>;
	session_load: Action_Event_Request_Response_Data<'session_load'>;
