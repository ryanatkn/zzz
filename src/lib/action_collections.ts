...
export interface Action_Event_Datas {
	create_directory: Request_Response_Action_Event_Data<'create_directory'>;
	delete_diskfile: Request_Response_Action_Event_Data<'delete_diskfile'>;
	filer_change: Remote_Notification_Action_Event_Data<'filer_change'>;
	load_session: Request_Response_Action_Event_Data<'load_session'>;
	ping: Request_Response_Action_Event_Data<'ping'>;
	submit_completion: Request_Response_Action_Event_Data<'submit_completion'>;
	toggle_main_menu: Local_Call_Action_Event_Data<'toggle_main_menu'>;
	update_diskfile: Request_Response_Action_Event_Data<'update_diskfile'>;
}
