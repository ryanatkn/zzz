...
pub const ShaderManager = struct {
    ...
    fn loadShaderFromFile(self: *ShaderManager, name: []const u8, shader_type: ShaderType, entry_point: []const u8, num_uniform_buffers: u32, num_samplers: u32, num_storage_buffers: u32, num_storage_textures: u32) !*c.sdl.SDL_GPUShader {
        // Construct file path
