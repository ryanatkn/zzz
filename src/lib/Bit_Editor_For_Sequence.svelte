<script lang="ts">
	...
	// TODO NEXT sequence bits are broken, add bit doesn't work

	// TODO NEXT what if we had a sequence bit per strip? maybe use A2A Parts instead though.
</script>
