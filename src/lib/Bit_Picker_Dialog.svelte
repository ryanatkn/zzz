...
<Picker_Dialog
	...
	sorters={[
		...
		sort_by_text<Bit_Union>('type_asc', 'type (a-z)', 'type'),
		sort_by_text<Bit_Union>('type_desc', 'type (z-a)', 'type', 'desc'),
		sort_by_text<Bit_Union>('name_asc', 'name (a-z)', 'name'),
		sort_by_text<Bit_Union>('name_desc', 'name (z-a)', 'name', 'desc'),
		sort_by_numeric<Bit_Union>('token_count_highest', 'tokens (most)', 'token_count', 'desc'),
		sort_by_numeric<Bit_Union>('token_count_lowest', 'tokens (least)', 'token_count', 'asc'),
	]}
