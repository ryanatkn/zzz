...
<div class="display_flex flex_direction_column">
			...
			<form class="flex_1">
				...
				<fieldset>
					...
					<div class="display_flex justify_content_space_between gap_xs">
						...
						>
							{#if updating}
								updating <Pending_Animation inline />
							{:else}
								update key
							{/if}
						</button>
			...
			<div class="flex_1">
				{#if show_info}
					...
					<ul>
						...
						<li>
							<External_Link href={provider.homepage}>homepage</External_Link>
						</li>
						<li>
	...
	{:else}
		<div class="py_sm">
			<Error_Message
				><small class="font_family_mono">provider "{provider_name}" not found</small></Error_Message
			>
		</div>
	{/if}
</div>
