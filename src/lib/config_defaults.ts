...
export const SYSTEM_MESSAGE_DEFAULT = 'You are a helpful assistant that responds succinctly.'; // TODO without the succintly part? I dont think splitting it for DEV makes sense
