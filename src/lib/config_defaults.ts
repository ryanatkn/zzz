...
export const models_default: Array<z.input<typeof Model_Json>> = [
	...
	{name: 'gpt-4o-mini', provider_name: 'chatgpt', tags: ['cheap']},
	{name: 'gpt-4.1', provider_name: 'chatgpt', tags: ['smart']},
	{name: 'gpt-4o', provider_name: 'chatgpt', tags: ['smart']},
...
export const chat_template_defaults: Array<Chat_Template> = [
	{
		...
		model_names: ['llama3.2:1b', 'gemma3:1b', 'qwen3:0.6b'],
	},
	{
		id: create_uuid(),
		name: 'frontier',
