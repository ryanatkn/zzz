...
export const package_json = {
	...
	exports: {
		...
		'./Payload_Detail.svelte': {
			types: './dist/Payload_Detail.svelte.d.ts',
			svelte: './dist/Payload_Detail.svelte',
			default: './dist/Payload_Detail.svelte',
		},
		'./Payload_Info.svelte': {
			types: './dist/Payload_Info.svelte.d.ts',
			svelte: './dist/Payload_Info.svelte',
			default: './dist/Payload_Info.svelte',
		},
		'./Payload_List.svelte': {
			types: './dist/Payload_List.svelte.d.ts',
			svelte: './dist/Payload_List.svelte',
			default: './dist/Payload_List.svelte',
		},
		'./Payload_Summary.svelte': {
			types: './dist/Payload_Summary.svelte.d.ts',
			svelte: './dist/Payload_Summary.svelte',
			default: './dist/Payload_Summary.svelte',
		},
		'./payload_types.js': {types: './dist/payload_types.d.ts', default: './dist/payload_types.js'},
		'./Payload_View.svelte': {
			types: './dist/Payload_View.svelte.d.ts',
			svelte: './dist/Payload_View.svelte',
			default: './dist/Payload_View.svelte',
		},
		'./payload.svelte.js': {
			types: './dist/payload.svelte.d.ts',
			default: './dist/payload.svelte.js',
		},
		'./payloads.svelte.js': {
			types: './dist/payloads.svelte.d.ts',
			default: './dist/payloads.svelte.js',
		},
		'./Picker.svelte': {
	...
	modules: {
		...
		'./bit.svelte.js': {
			...
			declarations: [
				...
				{name: 'Text_Bit_Options', kind: 'type'},
				{name: 'Diskfile_Bit_Options', kind: 'type'},
				{name: 'Sequence_Bit_Options', kind: 'type'},
				{name: 'Bit_Type_Options', kind: 'type'},
				{name: 'Bit', kind: 'class'},
				{name: 'Bit_Schema', kind: 'variable'},
				{name: 'Text_Bit', kind: 'class'},
				{name: 'Text_Bit_Schema', kind: 'variable'},
				{name: 'Diskfile_Bit', kind: 'class'},
				{name: 'Diskfile_Bit_Schema', kind: 'variable'},
				{name: 'Sequence_Bit', kind: 'class'},
				{name: 'Sequence_Bit_Schema', kind: 'variable'},
			],
		},
		'./bits.svelte.js': {
			path: 'bits.svelte.ts',
		...
		'./glyphs.js': {
			...
			declarations: [
				...
				{name: 'GLYPH_PAYLOAD', kind: 'variable'},
				...
				{name: 'get_icon_for_payload_type', kind: 'function'},
		...
		'./Payload_Detail.svelte': {path: 'Payload_Detail.svelte', declarations: []},
		'./Payload_Info.svelte': {path: 'Payload_Info.svelte', declarations: []},
		'./Payload_List.svelte': {path: 'Payload_List.svelte', declarations: []},
		'./Payload_Summary.svelte': {path: 'Payload_Summary.svelte', declarations: []},
		'./payload_types.js': {
			path: 'payload_types.ts',
			declarations: [
				{name: 'Payload_Direction', kind: 'variable'},
				{name: 'Payload_Type', kind: 'variable'},
				{name: 'Payload_Tape_History', kind: 'variable'},
				...
				{name: 'Payload_Base', kind: 'variable'},
				{name: 'Payload_Ping', kind: 'variable'},
				{name: 'Payload_Pong', kind: 'variable'},
				{name: 'Payload_Load_Session', kind: 'variable'},
				{name: 'Payload_Loaded_Session', kind: 'variable'},
				{name: 'Diskfile_Change', kind: 'variable'},
				{name: 'Payload_Filer_Change', kind: 'variable'},
				{name: 'Payload_Update_Diskfile', kind: 'variable'},
				{name: 'Payload_Delete_Diskfile', kind: 'variable'},
				{name: 'Payload_Create_Directory', kind: 'variable'},
				{name: 'Payload_Send_Prompt', kind: 'variable'},
				{name: 'Payload_Completion_Response', kind: 'variable'},
				{name: 'Payload_Client', kind: 'variable'},
				{name: 'Payload_Server', kind: 'variable'},
				{name: 'Payload', kind: 'variable'},
				{name: 'Payload_Json', kind: 'variable'},
				{name: 'create_payload_json', kind: 'function'},
			],
		},
		'./Payload_View.svelte': {path: 'Payload_View.svelte', declarations: []},
		'./payload.svelte.js': {
			path: 'payload.svelte.ts',
			declarations: [
				{name: 'PAYLOAD_DATE_FORMAT', kind: 'variable'},
				{name: 'PAYLOAD_TIME_FORMAT', kind: 'variable'},
				{name: 'Payload_Options', kind: 'type'},
				{name: 'Payload', kind: 'class'},
				{name: 'Payload_Schema', kind: 'variable'},
			],
		},
		'./payloads.svelte.js': {
			path: 'payloads.svelte.ts',
			declarations: [
				{name: 'HISTORY_LIMIT_DEFAULT', kind: 'variable'},
				{name: 'PONG_DISPLAY_LIMIT', kind: 'variable'},
				{name: 'Payloads_Json', kind: 'variable'},
				{name: 'Payloads_Options', kind: 'type'},
				{name: 'Payload_Multi_Index_Keys', kind: 'type'},
				{name: 'Payloads', kind: 'class'},
			],
		},
		...
		'./prompt.svelte.js': {
			...
			declarations: [
				...
				{name: 'Prompt_Payload_Content', kind: 'type'},
		...
		'./server/zzz_server.js': {
			...
			declarations: [
				{name: 'Payload_Handler', kind: 'type'},
		...
		'./socket.svelte.js': {
			...
			declarations: [
				...
				{name: 'Socket_Payload_Handler', kind: 'type'},
		...
		'./zzz.svelte.js': {
			...
			declarations: [
				...
				{name: 'Payload_With_History', kind: 'type'},
				{name: 'Zzz', kind: 'class'},
			],
		},
	},
