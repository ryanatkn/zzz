...
> ⚠️ AI slop code and docs, is unstable, insecure, and full of lies
...
- **Pure Zig font rendering** - TTF parsing with consistent baseline alignment ([docs](docs/font-system.md))
