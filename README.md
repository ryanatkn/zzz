...
It's both a customizable web user interface
and also a flexible tool for crafting UX-maximizing websites
...
([zzz.software](https://www.zzz.software/))
It will have another build with the Node adapter and a Hono server soon.
